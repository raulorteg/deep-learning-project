...
parser.add_argument('--use_backgrounds', type=int)
...
parser.add_argument('--num_neurons_encoder', type=str)
parser.add_argument('--num_neurons_policy', type=str)

hyperparameters = parser.parse_args().__dict__

hyperparameters['num_neurons_encoder'] = json.loads(hyperparameters['num_neurons_encoder'])
hyperparameters['num_neurons_policy'] = json.loads(hyperparameters['num_neurons_policy'])
